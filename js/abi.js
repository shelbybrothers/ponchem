...
export const LAB_ABI = Object.freeze([
  ...
  'function run(uint256 id) view returns (address wallet, uint16 targetId, uint16 ligandId, int32 scoreMilli, uint32 epoch, uint64 time, bytes32 poseHash)',
  ...
  'function submitRun(uint16 targetId, uint16 ligandId, int16[] pose) payable returns (uint256 runId, int32 scoreMilli)',
  'function submitRun(uint16 targetId, uint16 ligandId, int16[] pose, bool payWithToken) payable returns (uint256 runId, int32 scoreMilli)',
